...
c.JupyterHub.config_file = '/etc/jupyterhib/jupyterhub_config.py'
...
# c.JupyterHub.cookie_secret_file = '/tmp/USERNAME/jupyterhub_cookie_secret'
...
#
# Use with ssl_key
c.JupyterHub.ssl_cert = u'/etc/ssl/certs/server.crt'
# Path to SSL key file for the public facing interface of the proxy
#
# Use with ssl_cert
c.JupyterHub.ssl_key = u'/etc/ssl/certs/server.key'
...
c.LocalAuthenticator.add_user_cmd = ['adduser', '-q', '--gecos', '""', '--home', '/root/work/USERNAME','--disabled-password']
